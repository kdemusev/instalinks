function sc2Autosave(timer_id, table, field, where, cmp_val, animate_id, where2,
                     cmp_val2, allowdelete, noevent) {
...
sc2Autosave.prototype.save = function (val, period) {
  ...
  this.timer = setTimeout(function() {
    SMPAjaxPost('/autosave',
      ...
      alert('Возникла ошибка связи с сервером при сохранении данных. Проверьте соединение с интернетом. Чтобы избежать потерю несохраненных данных не закрывайте приложение и не совершайте переходы на другие страницы до подтверждения сохранения');
        self.save(val, 10000);
      } else {
