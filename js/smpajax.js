...
function SMPAjax(path, func, xml, post, data) {
    ...
    timeout = setTimeout(function() {
        request.close();
        alert('Невозможно получить ответ от сервера. Проверьте соединение с интернетом. Если остальные сайты открываются, то возможны технические перебои в работе сервиса. Попробуйте повторить запрос');
    }, 10000);
}
